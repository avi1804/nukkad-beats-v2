          ...
          <div className="flex flex-col md:flex-row gap-[40px] items-center md:items-start">
            ...
            <div className="flex-1 w-full flex flex-col">
              <div className="bg-gray-50 border border-gray-200 rounded-[16px] p-[24px] flex-1">
                <h3 className="text-text-white font-[700] text-[1.1rem] mb-[20px] border-b border-gray-200 pb-[12px]">Order Summary</h3>

                <div className="flex flex-col gap-[12px] mb-[24px]">
                  <div className="flex justify-between">
                    <span className="text-text-muted">Order ID</span>
                    <span className="font-[600] text-text-white">{order.orderReference}</span>
                  </div>
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-[600] text-text-white">
                ...
                <div className="flex flex-col gap-[8px] mb-[24px] max-h-[150px] overflow-y-auto scrollbar-hide pr-2">
                  {order.items?.map((item: any) => (
                    <div key={item.id} className="flex justify-between items-center text-[0.9rem]">
                      ...
                      <span className="text-text-white font-[600]">₹{item.price * item.quantity}</span>
                    </div>
                  ))}
                </div>

                <div className="mt-auto pt-[20px] border-t border-gray-200 flex justify-between items-center">
                  <span className="text-text-white font-[600] text-[1.1rem]">Total Amount</span>
